...
class Interpolator():
    ...
    def get_interpolators(self, X, it):
        ...
        # Take out subset of array, to pass to interpolation object
        # Fill NaN values (land cells) with 0, otherwise interpolation won't work
...
y = -1200000 + 10000*(np.sin(np.linspace(0, 12*np.pi, Nt)))**2
